    ...
    <div className="group relative">
      ...
      >
        ...
        {isActive &&
          !collapsed &&
          !danger && (
            <span className="ml-auto h-1.5 w-1.5 shrink-0 rounded-full bg-[#0b1220]/30" />
          )}
      </Link>
      ...
      {collapsed && (
        <div className="pointer-events-none absolute left-[calc(100%+12px)] top-1/2 z-[80] hidden -translate-y-1/2 whitespace-nowrap rounded-xl border border-white/[0.08] bg-[#111827] px-3 py-2 text-xs font-medium text-slate-200 shadow-[0_12px_35px_rgba(0,0,0,0.35)] group-hover:block">
          {title}
