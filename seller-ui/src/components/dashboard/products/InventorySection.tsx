      ...
      <div className="space-y-6 p-5 sm:p-6">
        ...
        >
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="rounded-2xl border border-black/[0.05] bg-white/80 px-4 py-3 text-left sm:text-right">
              <p className="text-[10px] font-medium uppercase tracking-[0.12em] text-neutral-400">
                Available
              </p>

              <p className="mt-1 text-lg font-semibold tracking-[-0.03em] text-neutral-950">
                {stock}{" "}
