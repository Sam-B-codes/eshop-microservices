...
const createServiceProxy = (
  ...
  proxy(target, {
    ...
    /*
     * Forward HTTP-only cookies and optional
    ...
    /*
     * Express has already parsed the request
     * body, so forward the parsed content.
     */
...
// ======================================================
//
// This must remain after every specific service route.
//
// ======================================================
